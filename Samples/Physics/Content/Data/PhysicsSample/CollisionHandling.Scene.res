<root dataType="Struct" type="Duality.Resources.Scene" id="129723834">
  ...
  <serializeObj dataType="Array" type="Duality.GameObject[]" id="427169525">
    ...
    <item dataType="Struct" type="Duality.GameObject" id="2113205685">
      ...
      <children dataType="Struct" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="1142515399">
        <_items dataType="Array" type="Duality.GameObject[]" id="915481294" length="8">
          ...
          <item dataType="Struct" type="Duality.GameObject" id="1570849254">
            <active dataType="Bool">true</active>
            <children />
            <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="1093271898">
              <_items dataType="Array" type="Duality.Component[]" id="2395479552" length="4">
                <item dataType="Struct" type="Duality.Components.Transform" id="1628126472">
                  <active dataType="Bool">true</active>
                  <angle dataType="Float">0</angle>
                  <angleAbs dataType="Float">0</angleAbs>
                  <gameobj dataType="ObjectRef">1570849254</gameobj>
                  <ignoreParent dataType="Bool">false</ignoreParent>
                  <pos dataType="Struct" type="Duality.Vector3">
                    <X dataType="Float">0</X>
                ...
                <item dataType="Struct" type="Duality.Components.Physics.RigidBody" id="1105778742">
                  <active dataType="Bool">true</active>
                  <allowParent dataType="Bool">false</allowParent>
                  <angularDamp dataType="Float">0.3</angularDamp>
                  <angularVel dataType="Float">0</angularVel>
                  ...
                  <linearVel dataType="Struct" type="Duality.Vector2" />
                  <revolutions dataType="Float">0</revolutions>
                  <shapes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.ShapeInfo]]" id="2795076758">
                    <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="1660838432">
                      <item dataType="Struct" type="Duality.Components.Physics.PolyShapeInfo" id="866358236">
                        <convexPolygons dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Vector2[]]]" id="562145988">
                          <_items dataType="Array" type="Duality.Vector2[][]" id="27959108" length="4" />
                          <_size dataType="Int">0</_size>
                        </convexPolygons>
                        <density dataType="Float">1</density>
                        <friction dataType="Float">0.3</friction>
                        <parent dataType="ObjectRef">1105778742</parent>
                        <restitution dataType="Float">0</restitution>
                        <sensor dataType="Bool">false</sensor>
                        <userTag dataType="Int">0</userTag>
                        <vertices dataType="Array" type="Duality.Vector2[]" id="1907823510">
                          <item dataType="Struct" type="Duality.Vector2">
                            <X dataType="Float">-320</X>
                            <Y dataType="Float">-16</Y>
                          </item>
                ...
                <item dataType="Struct" type="Duality.Components.Renderers.RigidBodyRenderer" id="329855916">
                  <active dataType="Bool">true</active>
                  <areaMaterial dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Material]]">
                    <contentPath dataType="String">Default:Material:SolidBlack</contentPath>
                  </areaMaterial>
            ...
            <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="3835250618" surrogate="true">
              <header />
              <body>
                <keys dataType="Array" type="System.Object[]" id="3885123232">
                  <item dataType="ObjectRef">4256166190</item>
                  <item dataType="ObjectRef">1621942054</item>
                  <item dataType="ObjectRef">3537758906</item>
                </keys>
                <values dataType="Array" type="System.Object[]" id="523555982">
                  <item dataType="ObjectRef">1628126472</item>
                  <item dataType="ObjectRef">1105778742</item>
                  <item dataType="ObjectRef">329855916</item>
                </values>
              </body>
            </compMap>
            <compTransform dataType="ObjectRef">1628126472</compTransform>
            <identifier dataType="Struct" type="System.Guid" surrogate="true">
              <header>
                <data dataType="Array" type="System.Byte[]" id="1499492028">a08YhFUxR0uNYyRo5i7wgA==</data>
              </header>
              <body />
            </identifier>
            <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
    ...
    <item dataType="Struct" type="Duality.GameObject" id="5037571">
      ...
      <children dataType="Struct" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="3827611569">
        <_items dataType="Array" type="Duality.GameObject[]" id="847241774" length="8">
          <item dataType="Struct" type="Duality.GameObject" id="9519784">
            <active dataType="Bool">true</active>
            <children dataType="Struct" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="388462516">
              <_items dataType="Array" type="Duality.GameObject[]" id="1270992804" length="8">
                <item dataType="Struct" type="Duality.GameObject" id="3649182789">
                  <active dataType="Bool">true</active>
                  <children />
                  <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="2328281065">
                    <_items dataType="Array" type="Duality.Component[]" id="2491148046">
                      ...
                      <item dataType="Struct" type="Duality.Components.Physics.RigidBody" id="3184112277">
                        ...
                        <linearVel dataType="Struct" type="Duality.Vector2" />
                        <revolutions dataType="Float">0</revolutions>
                        <shapes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.ShapeInfo]]" id="704202517">
                          <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="1502193782">
                            <item dataType="Struct" type="Duality.Components.Physics.CircleShapeInfo" id="796721120">
                              <density dataType="Float">1</density>
                              <friction dataType="Float">0.3</friction>
                            ...
                            <item dataType="Struct" type="Duality.Components.Physics.PolyShapeInfo" id="2831442830">
                              <convexPolygons dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Vector2[]]]" id="299951922">
                                <_items dataType="Array" type="Duality.Vector2[][]" id="1507778512" length="4" />
                                <_size dataType="Int">0</_size>
                              </convexPolygons>
                              <density dataType="Float">1</density>
                              <friction dataType="Float">0.3</friction>
                              ...
                              <sensor dataType="Bool">false</sensor>
                              <userTag dataType="Int">0</userTag>
                              <vertices dataType="Array" type="Duality.Vector2[]" id="396341066">
                                <item dataType="Struct" type="Duality.Vector2">
                      ...
                      <item dataType="Struct" type="Duality.Samples.Physics.CollisionEventLogger" id="3739764833">
                        <active dataType="Bool">true</active>
                        <gameobj dataType="ObjectRef">3649182789</gameobj>
                      </item>
                    </_items>
                  ...
                  <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="2237132992" surrogate="true">
                    <header />
                    <body>
                      <keys dataType="Array" type="System.Object[]" id="3576429667">
                        <item dataType="ObjectRef">4256166190</item>
                        <item dataType="ObjectRef">1621942054</item>
                        <item dataType="ObjectRef">3537758906</item>
                        <item dataType="Type" id="919677670" value="Duality.Samples.Physics.CollisionEventLogger" />
                      </keys>
                      <values dataType="Array" type="System.Object[]" id="2240380152">
                        <item dataType="ObjectRef">3706460007</item>
                        <item dataType="ObjectRef">3184112277</item>
                        <item dataType="ObjectRef">2408189451</item>
                        <item dataType="ObjectRef">3739764833</item>
                      </values>
                    </body>
                  </compMap>
                  ...
                  <identifier dataType="Struct" type="System.Guid" surrogate="true">
                    <header>
                      <data dataType="Array" type="System.Byte[]" id="2345064393">dpcp9Sffq0qibCzWsYg6dA==</data>
                    </header>
                    <body />
                  </identifier>
                  <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
                  <name dataType="String">MultiShape</name>
                  <parent dataType="ObjectRef">9519784</parent>
                  <prefabLink />
                </item>
                <item dataType="Struct" type="Duality.GameObject" id="2160834674">
                  <active dataType="Bool">true</active>
                  <children />
                  <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="1770180066">
                    <_items dataType="Array" type="Duality.Component[]" id="215551632">
                      ...
                      <item dataType="Struct" type="Duality.Components.Physics.RigidBody" id="1695764162">
                        ...
                        <linearVel dataType="Struct" type="Duality.Vector2" />
                        <revolutions dataType="Float">0</revolutions>
                        <shapes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.ShapeInfo]]" id="944871386">
                          <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="4123977984">
                            <item dataType="Struct" type="Duality.Components.Physics.PolyShapeInfo" id="3469021852">
                              <convexPolygons dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Vector2[]]]" id="3465345988">
                                <_items dataType="Array" type="Duality.Vector2[][]" id="851127620" length="4" />
                                <_size dataType="Int">0</_size>
                              </convexPolygons>
                              <density dataType="Float">1</density>
                              <friction dataType="Float">0.3</friction>
                              ...
                              <sensor dataType="Bool">false</sensor>
                              <userTag dataType="Int">0</userTag>
                              <vertices dataType="Array" type="Duality.Vector2[]" id="527504790">
                                <item dataType="Struct" type="Duality.Vector2">
                      ...
                      <item dataType="Struct" type="Duality.Samples.Physics.CollisionEventLogger" id="2251416718">
                        <active dataType="Bool">true</active>
                        <gameobj dataType="ObjectRef">2160834674</gameobj>
                      </item>
                    </_items>
                  ...
                  <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="414284938" surrogate="true">
                    <header />
                    <body>
                      <keys dataType="Array" type="System.Object[]" id="1855247224">
                        <item dataType="ObjectRef">4256166190</item>
                        <item dataType="ObjectRef">1621942054</item>
                        <item dataType="ObjectRef">3537758906</item>
                        <item dataType="ObjectRef">919677670</item>
                      </keys>
                      <values dataType="Array" type="System.Object[]" id="1675729886">
                        <item dataType="ObjectRef">2218111892</item>
                        <item dataType="ObjectRef">1695764162</item>
                        <item dataType="ObjectRef">919841336</item>
                        <item dataType="ObjectRef">2251416718</item>
                      </values>
                    </body>
                  </compMap>
                  ...
                  <identifier dataType="Struct" type="System.Guid" surrogate="true">
                    <header>
                      <data dataType="Array" type="System.Byte[]" id="4214820388">ZegoVuGnJkOnxUSZ/j6BIA==</data>
                    </header>
                    <body />
                  </identifier>
                  <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
                ...
                <item dataType="Struct" type="Duality.GameObject" id="2514324034">
                  <active dataType="Bool">true</active>
                  <children dataType="Struct" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="1522429170">
                    <_items dataType="Array" type="Duality.GameObject[]" id="539069904" length="4" />
                    <_size dataType="Int">0</_size>
                  </children>
                  <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="3741806922">
                    <_items dataType="Array" type="Duality.Component[]" id="1018221288">
                      ...
                      <item dataType="Struct" type="Duality.Components.Physics.RigidBody" id="2049253522">
                        ...
                        <linearVel dataType="Struct" type="Duality.Vector2" />
                        <revolutions dataType="Float">0</revolutions>
                        <shapes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.ShapeInfo]]" id="1303292794">
                          <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="4253700992" length="4">
                            <item dataType="Struct" type="Duality.Components.Physics.CircleShapeInfo" id="584372636">
                              <density dataType="Float">1</density>
                              <friction dataType="Float">0.3</friction>
                      ...
                      <item dataType="Struct" type="Duality.Samples.Physics.CollisionEventLogger" id="2604906078">
                        <active dataType="Bool">true</active>
                        <gameobj dataType="ObjectRef">2514324034</gameobj>
                      </item>
                    </_items>
                  ...
                  <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="1137590210" surrogate="true">
                    <header />
                    <body>
                      <keys dataType="Array" type="System.Object[]" id="3014619424">
                        <item dataType="ObjectRef">4256166190</item>
                        <item dataType="ObjectRef">1621942054</item>
                        <item dataType="ObjectRef">3537758906</item>
                        <item dataType="ObjectRef">919677670</item>
                      </keys>
                      <values dataType="Array" type="System.Object[]" id="73944974">
                        <item dataType="ObjectRef">2571601252</item>
                        <item dataType="ObjectRef">2049253522</item>
                        <item dataType="ObjectRef">1273330696</item>
                        <item dataType="ObjectRef">2604906078</item>
                      </values>
                    </body>
                  </compMap>
                  ...
                  <identifier dataType="Struct" type="System.Guid" surrogate="true">
                    <header>
                      <data dataType="Array" type="System.Byte[]" id="1291638844">SqV/g4TJ0kqDSmpt6jIhgw==</data>
                    </header>
                    <body />
                  </identifier>
                  <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
                ...
                <item dataType="Struct" type="Duality.GameObject" id="1647965241">
                  <active dataType="Bool">true</active>
                  <children />
                  <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="3672581317">
                    <_items dataType="Array" type="Duality.Component[]" id="1961923286">
                      ...
                      <item dataType="Struct" type="Duality.Components.Physics.RigidBody" id="1182894729">
                        ...
                        <linearVel dataType="Struct" type="Duality.Vector2" />
                        <revolutions dataType="Float">0</revolutions>
                        <shapes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.ShapeInfo]]" id="3852157417">
                          <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="239471374">
                            <item dataType="Struct" type="Duality.Components.Physics.PolyShapeInfo" id="3542736336">
                              <convexPolygons dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Vector2[]]]" id="576757436">
                                <_items dataType="Array" type="Duality.Vector2[][]" id="552751684" length="4" />
                                <_size dataType="Int">0</_size>
                              </convexPolygons>
                              <density dataType="Float">1</density>
                              <friction dataType="Float">0.3</friction>
                              ...
                              <sensor dataType="Bool">false</sensor>
                              <userTag dataType="Int">0</userTag>
                              <vertices dataType="Array" type="Duality.Vector2[]" id="2176496278">
                                <item dataType="Struct" type="Duality.Vector2">
                      ...
                      <item dataType="Struct" type="Duality.Samples.Physics.CollisionEventLogger" id="1738547285">
                        <active dataType="Bool">true</active>
                        <gameobj dataType="ObjectRef">1647965241</gameobj>
                      </item>
                    </_items>
                  ...
                  <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="2058015272" surrogate="true">
                    <header />
                    <body>
                      <keys dataType="Array" type="System.Object[]" id="3017449391">
                        <item dataType="ObjectRef">4256166190</item>
                        <item dataType="ObjectRef">1621942054</item>
                        <item dataType="ObjectRef">3537758906</item>
                        <item dataType="ObjectRef">919677670</item>
                      </keys>
                      <values dataType="Array" type="System.Object[]" id="1664706720">
                        <item dataType="ObjectRef">1705242459</item>
                        <item dataType="ObjectRef">1182894729</item>
                        <item dataType="ObjectRef">406971903</item>
                        <item dataType="ObjectRef">1738547285</item>
                      </values>
                    </body>
                  </compMap>
                  ...
                  <identifier dataType="Struct" type="System.Guid" surrogate="true">
                    <header>
                      <data dataType="Array" type="System.Byte[]" id="3867702589">onO4VJWaqkS4KC0qjNcS1w==</data>
                    </header>
                    <body />
                  </identifier>
                  <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
            ...
            <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="3536528886">
              <_items dataType="Array" type="Duality.Component[]" id="2643536542" length="0" />
              <_size dataType="Int">0</_size>
            </compList>
            <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="2747639824" surrogate="true">
              <header />
              <body>
                <keys dataType="Array" type="System.Object[]" id="589973000" length="0" />
                <values dataType="Array" type="System.Object[]" id="323616222" length="0" />
              </body>
            </compMap>
            <compTransform />
            <identifier dataType="Struct" type="System.Guid" surrogate="true">
              <header>
                <data dataType="Array" type="System.Byte[]" id="1724107252">iVJTuXMqDU2+hq4TlltUAA==</data>
              </header>
              <body />
            </identifier>
            <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
          ...
          <item dataType="Struct" type="Duality.GameObject" id="3448835305">
            ...
            <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="3401557120">
              <_items dataType="ObjectRef">2643536542</_items>
              <_size dataType="Int">0</_size>
            </compList>
    ...
    <item dataType="ObjectRef">1570849254</item>
    <item dataType="ObjectRef">9519784</item>
