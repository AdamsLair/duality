...
namespace Duality.Samples.Benchmarks
{
    ...
    public class BenchmarkStaticMultiSpriteRenderer : Renderer, ICmpInitializable
	{
		...
		[DontSerialize] private VertexBuffer geometry = null;
		[DontSerialize] private DrawBatch batch = null;
		...
		private void GenerateGeometry()
		{
			...
			this.batch = new DrawBatch(
				this.geometry,
				new RawList<VertexDrawRange>() { new VertexDrawRange(0, count * 4) },
				VertexMode.Quads,
				this.sharedMaterial);
		}
