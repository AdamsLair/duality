...
namespace Duality.Editor.Plugins.PackageManagerFrontend.Properties
{
	public static class PackageManagerFrontendResCache
	{
		...
		public static readonly Image IconLikelyUnsafeInstall = PackageManagerFrontendRes.IconLikelyUnsafeInstall;
		public static readonly Image IconIncompatibleInstall = PackageManagerFrontendRes.IconIncompatibleInstall;
