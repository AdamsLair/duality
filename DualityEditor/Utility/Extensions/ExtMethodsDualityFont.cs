...
namespace Duality.Editor
{
	public static class ExtMethodsDualityFont
	{
		...
		/// </summary>
		public static void RenderGlyphs(this DualityFont font, FontCharSet extendedSet)
		{
		...
		/// </summary>
		public static void RenderGlyphs(this DualityFont font, FontFamily fontFamily, FontCharSet extendedSet)
		{
		...
		/// </summary>
		private static void RenderGlyphs(DualityFont target, SysDrawFont internalFont, FontCharSet charSet)
		{
