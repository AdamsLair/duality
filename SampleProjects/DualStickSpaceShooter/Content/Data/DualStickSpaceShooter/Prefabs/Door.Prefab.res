<root dataType="Struct" type="Duality.Resources.Prefab" id="129723834">
  <objTree dataType="Struct" type="Duality.GameObject" id="2563084184">
    <active dataType="Bool">true</active>
    <children dataType="Struct" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="124977551">
      <_items dataType="Array" type="Duality.GameObject[]" id="1956275886" length="4">
        <item dataType="Struct" type="Duality.GameObject" id="216523726">
          <active dataType="Bool">true</active>
          <children dataType="Struct" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="1760227138">
            <_items dataType="Array" type="Duality.GameObject[]" id="2954081296" length="4">
              <item dataType="Struct" type="Duality.GameObject" id="4239836804">
                <active dataType="Bool">true</active>
                <children />
                <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="971126892">
                  <_items dataType="Array" type="Duality.Component[]" id="3519586148" length="4">
                    <item dataType="Struct" type="Duality.Components.Transform" id="2305184440">
                      <active dataType="Bool">true</active>
                      ...
                      <parentTransform dataType="Struct" type="Duality.Components.Transform" id="2576838658">
                        <active dataType="Bool">true</active>
                        <angle dataType="Float">0</angle>
                        <angleAbs dataType="Float">0</angleAbs>
                        <angleVel dataType="Float">0</angleVel>
                        ...
                        <ignoreParent dataType="Bool">false</ignoreParent>
                        <parentTransform dataType="Struct" type="Duality.Components.Transform" id="628431820">
                          <active dataType="Bool">true</active>
                          <angle dataType="Float">0</angle>
                          <angleAbs dataType="Float">0</angleAbs>
                          <angleVel dataType="Float">0</angleVel>
                    ...
                    <item dataType="Struct" type="Duality.Components.Physics.RigidBody" id="3007646032">
                      ...
                      <joints dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.JointInfo]]" id="1444635672">
                        <_items dataType="Array" type="Duality.Components.Physics.JointInfo[]" id="1463964716">
                          <item dataType="Struct" type="Duality.Components.Physics.PrismaticJointInfo" id="1877038308">
                            ...
                            <otherBody dataType="Struct" type="Duality.Components.Physics.RigidBody" id="3279300250">
                              ...
                              <shapes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.ShapeInfo]]" id="1456403258">
                                <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="273548224" length="4">
                                  <item dataType="Struct" type="Duality.Components.Physics.CircleShapeInfo" id="1292448540">
                ...
                <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="604273718" surrogate="true">
                  <header />
                  <body>
                    <keys dataType="Array" type="System.Type[]" id="1322370214">
                      <item dataType="Type" id="4008808960" value="Duality.Components.Transform" />
                      <item dataType="Type" id="4081385422" value="Duality.Components.Physics.RigidBody" />
                      <item dataType="Type" id="3600601756" value="Duality.Components.Renderers.RigidBodyRenderer" />
                    </keys>
                    <values dataType="Array" type="Duality.Component[]" id="3366980538">
                      <item dataType="ObjectRef">2305184440</item>
                      <item dataType="ObjectRef">3007646032</item>
                      <item dataType="ObjectRef">543562698</item>
                    </values>
                  </body>
                </compMap>
                <compTransform dataType="ObjectRef">2305184440</compTransform>
                <identifier dataType="Struct" type="System.Guid" surrogate="true">
                  <header>
                    <data dataType="Array" type="System.Byte[]" id="2668795558">lYYLhL2XAkCNdO+kSVYqEw==</data>
                  </header>
                  <body />
                </identifier>
                <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
                <name dataType="String">DoorPanel</name>
                <parent dataType="ObjectRef">216523726</parent>
                <prefabLink />
              </item>
            </_items>
            <_size dataType="Int">1</_size>
          ...
          <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="3862505482">
            <_items dataType="Array" type="Duality.Component[]" id="1815788056" length="4">
              <item dataType="ObjectRef">2576838658</item>
              <item dataType="ObjectRef">3279300250</item>
              <item dataType="Struct" type="DualStickSpaceShooter.DoorControl" id="1806133929">
                <active dataType="Bool">true</active>
                ...
                <moveSound dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Sound]]">
                  <contentPath dataType="String">Data\DualStickSpaceShooter\Audio\DoorLoop.Sound.res</contentPath>
                </moveSound>
          ...
          <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="2015781170" surrogate="true">
            <header />
            <body>
              <keys dataType="Array" type="System.Type[]" id="3920316832">
                <item dataType="ObjectRef">4008808960</item>
                <item dataType="ObjectRef">4081385422</item>
                <item dataType="Type" id="1949457116" value="DualStickSpaceShooter.DoorControl" />
              </keys>
              <values dataType="Array" type="Duality.Component[]" id="2736004750">
                <item dataType="ObjectRef">2576838658</item>
                <item dataType="ObjectRef">3279300250</item>
                <item dataType="ObjectRef">1806133929</item>
              </values>
            </body>
          </compMap>
          <compTransform dataType="ObjectRef">2576838658</compTransform>
          <identifier dataType="Struct" type="System.Guid" surrogate="true">
            <header>
              <data dataType="Array" type="System.Byte[]" id="638152124">+6Fm2IHcpUKTCwhIMylgkA==</data>
            </header>
            <body />
          </identifier>
          <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
          <name dataType="String">DoorLower</name>
          <parent dataType="ObjectRef">2563084184</parent>
          <prefabLink />
        </item>
        <item dataType="Struct" type="Duality.GameObject" id="574043733">
          <active dataType="Bool">true</active>
          <children dataType="Struct" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="3787929045">
            <_items dataType="Array" type="Duality.GameObject[]" id="2156137462" length="4">
              <item dataType="Struct" type="Duality.GameObject" id="1863053403">
                <active dataType="Bool">true</active>
                <children />
                <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="3647683531">
                  <_items dataType="Array" type="Duality.Component[]" id="2517012982" length="4">
                    <item dataType="Struct" type="Duality.Components.Transform" id="4223368335">
                      <active dataType="Bool">true</active>
                      <angle dataType="Float">0</angle>
                      <angleAbs dataType="Float">0</angleAbs>
                      <angleVel dataType="Float">0</angleVel>
                      ...
                      <ignoreParent dataType="Bool">false</ignoreParent>
                      <parentTransform dataType="Struct" type="Duality.Components.Transform" id="2934358665">
                        <active dataType="Bool">true</active>
                        <angle dataType="Float">0</angle>
                        <angleAbs dataType="Float">0</angleAbs>
                        <angleVel dataType="Float">0</angleVel>
                    ...
                    <item dataType="Struct" type="Duality.Components.Physics.RigidBody" id="630862631">
                      ...
                      <gameobj dataType="ObjectRef">1863053403</gameobj>
                      <ignoreGravity dataType="Bool">false</ignoreGravity>
                      <joints dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.JointInfo]]" id="3775977863">
                        <_items dataType="Array" type="Duality.Components.Physics.JointInfo[]" id="229647182">
                          <item dataType="Struct" type="Duality.Components.Physics.PrismaticJointInfo" id="1410665168">
                            ...
                            <otherBody dataType="Struct" type="Duality.Components.Physics.RigidBody" id="3636820257">
                              ...
                              <revolutions dataType="Float">0</revolutions>
                              <shapes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Components.Physics.ShapeInfo]]" id="847560808">
                                <_items dataType="Array" type="Duality.Components.Physics.ShapeInfo[]" id="758040655" length="4">
                                  <item dataType="Struct" type="Duality.Components.Physics.CircleShapeInfo" id="3590054446">
                                    <density dataType="Float">1</density>
                                    <friction dataType="Float">0.3</friction>
                ...
                <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="1931270728" surrogate="true">
                  <header />
                  <body>
                    <keys dataType="Array" type="System.Type[]" id="4209195489">
                      <item dataType="ObjectRef">4008808960</item>
                      <item dataType="ObjectRef">4081385422</item>
                      <item dataType="ObjectRef">3600601756</item>
                    </keys>
                    <values dataType="Array" type="Duality.Component[]" id="2313787424">
                      <item dataType="ObjectRef">4223368335</item>
                      <item dataType="ObjectRef">630862631</item>
                      <item dataType="ObjectRef">2461746593</item>
                    </values>
                  </body>
                </compMap>
                <compTransform dataType="ObjectRef">4223368335</compTransform>
                <identifier dataType="Struct" type="System.Guid" surrogate="true">
                  <header>
                    <data dataType="Array" type="System.Byte[]" id="2630044531">KL4yNTko/U66+nLO3AVojg==</data>
                  </header>
                  <body />
                </identifier>
                <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
                <name dataType="String">DoorPanel</name>
                <parent dataType="ObjectRef">574043733</parent>
                <prefabLink />
              </item>
            </_items>
            <_size dataType="Int">1</_size>
          ...
          <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="481556552">
            <_items dataType="Array" type="Duality.Component[]" id="1884439295" length="4">
              <item dataType="ObjectRef">2934358665</item>
              <item dataType="ObjectRef">3636820257</item>
              <item dataType="Struct" type="DualStickSpaceShooter.DoorControl" id="2163653936">
                <active dataType="Bool">true</active>
                <closeSpeed dataType="Float">1</closeSpeed>
          ...
          <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="2118459871" surrogate="true">
            <header />
            <body>
              <keys dataType="Array" type="System.Type[]" id="140693252">
                <item dataType="ObjectRef">4008808960</item>
                <item dataType="ObjectRef">4081385422</item>
                <item dataType="ObjectRef">1949457116</item>
              </keys>
              <values dataType="Array" type="Duality.Component[]" id="2853333398">
                <item dataType="ObjectRef">2934358665</item>
                <item dataType="ObjectRef">3636820257</item>
                <item dataType="ObjectRef">2163653936</item>
              </values>
            </body>
          </compMap>
          <compTransform dataType="ObjectRef">2934358665</compTransform>
          <identifier dataType="Struct" type="System.Guid" surrogate="true">
            <header>
              <data dataType="Array" type="System.Byte[]" id="1332166080">Q3KjyJSBqESNNmsDNJRIvg==</data>
            </header>
            <body />
          </identifier>
          <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
    ...
    <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="1130352605" surrogate="true">
      <header />
      <body>
        <keys dataType="Array" type="System.Type[]" id="1745540004">
          <item dataType="ObjectRef">4008808960</item>
        </keys>
        <values dataType="Array" type="Duality.Component[]" id="391921430">
          <item dataType="ObjectRef">628431820</item>
        </values>
      </body>
    </compMap>
    <compTransform dataType="ObjectRef">628431820</compTransform>
    <identifier dataType="Struct" type="System.Guid" surrogate="true">
      <header>
        <data dataType="Array" type="System.Byte[]" id="2424402592">wMoZXNydyUWQsVl3q+bPkQ==</data>
      </header>
      <body />
    </identifier>
    <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
  ...
  <sourcePath dataType="String">Door</sourcePath>
</root>
