...
namespace Duality.Samples.Physics
{
    ...
    public class ApplyVelocityWhileColliding : Component, ICmpUpdatable, ICmpCollisionListener
	{
		...
		void ICmpUpdatable.OnUpdate()
		{
			...
			foreach (GameObject obj in this.touchingObjects.Keys)
			{
				...
				// Apply a fixed velocity to the object
				Vector2 velocityDirection = -Vector2.UnitY;
				Vector2 applyWorldPos = obj.Transform.Pos.Xy;
				body.LinearVelocity = velocityDirection * 2.0f;
