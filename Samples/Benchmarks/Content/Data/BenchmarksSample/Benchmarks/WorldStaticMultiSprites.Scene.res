    ...
    <item dataType="Struct" type="Duality.GameObject" id="2821186619">
      ...
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="4018928969">
        <_items dataType="Array" type="Duality.Component[]" id="1568848782" length="4">
          <item dataType="Struct" type="Duality.Samples.Benchmarks.StaticMultiSpriteRendererSetup" id="549219108">
            <active dataType="Bool">true</active>
      ...
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="255470400" surrogate="true">
        ...
        <body>
          <keys dataType="Array" type="System.Object[]" id="3183015683">
            <item dataType="Type" id="1530498342" value="Duality.Samples.Benchmarks.StaticMultiSpriteRendererSetup" />
          </keys>
          <values dataType="Array" type="System.Object[]" id="1640358840">
            <item dataType="ObjectRef">549219108</item>
          </values>
        </body>
      </compMap>
      <compTransform />
        ...
        <changes dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Resources.PrefabLink+VarMod]]" id="2596664356">
          <_items dataType="Array" type="Duality.Resources.PrefabLink+VarMod[]" id="3933067972" length="4">
            <item dataType="Struct" type="Duality.Resources.PrefabLink+VarMod">
              ...
              <val dataType="String">This benchmark tests 10000 static sprites (~50% culled), rendered in large batches and sharing the same material. The vertex data is generated only once, uploaded to the GPU using a VertexBuffer, and then re-used every frame.</val>
            </item>
            <item dataType="Struct" type="Duality.Resources.PrefabLink+VarMod">
              ...
              <val dataType="String">Static Renderers</val>
            </item>
          </_items>
